...
| *`time`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#time-v1-meta[$$Time$$]__ | Time of entry
...
| *`selector`* __link:https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.18/#labelselector-v1-meta[$$LabelSelector$$]__ | Selector selects something
